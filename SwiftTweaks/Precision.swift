...
extension Double: Roundable {
    /// Returns the value, rounded to the given precision level.
    internal func roundToNearest(_ precisionLevel: PrecisionLevel) -> Double {
        ...
        let roundedValue = (doubleValue / precisionLevel.precision).rounded()
        return roundedValue * precisionLevel.precision
    }
...
extension CGFloat: Roundable {
    ...
    internal func roundToNearest(_ precisionLevel: PrecisionLevel) -> CGFloat {
