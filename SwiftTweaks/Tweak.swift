...
extension Tweak {
    ...
    public static func optionsList(_ collectionName: String, _ groupName: String, _ tweakName: String, options: [String], defaultValue: String? = nil) -> Tweak<StringOption> {
        precondition(!options.isEmpty, "Options list cannot be empty (optionsList tweak \(tweakName)")
        precondition(
            defaultValue == nil || (defaultValue != nil && options.index(of: defaultValue!) != nil), "The default value \(defaultValue) of the stringList tweak \(tweakName) must be in the list of options \(options) "
        )
        ...
        return Tweak<StringOption>(
            ...
            options: options.map{ StringOption(value: $0) }
        )
    }
}
...
extension Tweak: TweakType {
	...
	public var tweakDefaultData: TweakDefaultData {
        ...
        case .optionsList:
            return .optionsList(defaultValue: defaultValue as! StringOption,
