...
internal final class FloatingTweakGroupViewController: UIViewController {
	...
	private let closeButton: UIButton = {
		...
		button.setImage(buttonImage.imageTintedWithColor(AppTheme.Colors.controlTinted), for: .normal)
	...
	fileprivate let restoreButton: UIButton = {
		...
		button.setImage(buttonImage.imageTintedWithColor(AppTheme.Colors.controlSecondary), for: .normal)
...
extension FloatingTweakGroupViewController: UIGestureRecognizerDelegate {
	@objc func gestureRecognizerShouldBegin(_ gestureRecognizer: UIGestureRecognizer) -> Bool {
		...
		let gestureIsNotOnAControl = !(hitView is UIControl)
