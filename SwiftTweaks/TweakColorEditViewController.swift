...
internal final class TweakColorEditViewController: UIViewController {
    ...
    var viewData: ColorRepresentation {
		didSet {
	...
	override func viewDidLoad() {
		...
		headerView.bounds = CGRect(origin: .zero, size: CGSize(width: view.bounds.width, height: 122))
        ...
        (solidFrame, _) = colorPreviewView.bounds.divided(atDistance: colorPreviewView.bounds.width/2, from: CGRectEdge.minXEdge)
